...
export const RenderColour = React.forwardRef((props, ref) => {
    const {
        type,
        value,
        markers,
        ...
        >
            <Card padding={[4, 4, 4, 4]} shadow={1} radius={2}>
                <Stack space={[3, 3, 4]}>
                    ...
                    <Text size={1}>
                        This tool uses the Web Content Accessibility Guidelines’s formula for colour
                        contrast to compare the text colour to the background colour you select. Aim
                        to choose a background colour that passes level AA for both regular and large text sizes.
                    </Text>
                </Stack>
            </Card>
        </FormField>
